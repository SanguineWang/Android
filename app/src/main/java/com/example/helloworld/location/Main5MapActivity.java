...
public class Main5MapActivity extends AppCompatActivity implements LocationSource, AMapLocationListener {
   //初始化地图对象
...
//    权限申请接口回调
    ...
    PermissionsUtils.IPermissionsResult permissionsResult = new PermissionsUtils.IPermissionsResult() {
        ...
        public void passPermissons() {
            Toast.makeText(Main5MapActivity.this, "权限通过", Toast.LENGTH_SHORT).show();
        }

        @Override
        public void forbitPermissons() {
//            finish();
            Toast.makeText(Main5MapActivity.this, "权限不通过!", Toast.LENGTH_SHORT).show();
        }
    };
